...
use crate::pipeline::output::display_backend::{DisplayBackend, DisplayRegion, DmaTransfer};
...
impl<FB, Xfer: crate::pipeline::output::display_backend::AsyncDmaTransfer<Buffer = FB>>
    FrontState<FB, Xfer>
{
    ...
    B: DisplayBackend<W, H, FB>,
{
    ...
    /// Returns the active [`crate::pipeline::effects::InterlaceField`] (`Even` or `Odd`) for the current frame count.
    #[inline]
    pub fn current_interlace_field(&self) -> crate::pipeline::effects::InterlaceField {
        if (self.frame_count & 1) == 0 {
            crate::pipeline::effects::InterlaceField::Even
        } else {
            crate::pipeline::effects::InterlaceField::Odd
        }
    }
    ...
    where
        B::Transfer: crate::pipeline::output::display_backend::AsyncDmaTransfer<
                Buffer = FrameBuf<Rgb565, FB>,
            >,
    {
        if let Some(state) = self.front.take() {
    ...
    where
        F: FnOnce(
            ...
            B::Transfer,
            crate::pipeline::output::display_backend::TransferError<FB>,
        >,
    {
...
mod tests {
    extern crate std;
    use super::*;
    use crate::pipeline::output::display_backend::{DmaTransfer, SimulatorBackend, TransferError};
    use core::cell::Cell;
    ...
    impl<FB: DMACapableFrameBufferBackend<Color = Rgb565>>
        crate::pipeline::output::display_backend::AsyncDmaTransfer for TrackingTransfer<FB>
    {
