//! Triangle area/coverage tests and the generic FragmentShader triangle path.
...
use crate::ZDepth;
use crate::pipeline::rasterize::raster::scanline::EdgeStepper;
use crate::pipeline::shade::shader::FragmentShader;
...
mod tests {
    use super::*;
    use crate::pipeline::shade::shader::FlatColorShader;
