...
// Curated surface: the public entry points plus `RasterState`. Everything else
// is reached through its own submodule (e.g. `draw::blend::blend_q8`), so this
// module's accidental public API cannot leak every internal helper.
#[cfg(feature = "aa")]
pub use aa::draw_zbuffered_2xssaa;
pub use blend::{
...
pub use zbuffered::{
    ...
    draw_zbuffered_with_options, draw_zbuffered_with_state,
};
...
mod tests {
    extern crate std;
    use super::*;
    use crate::pipeline::effects::DepthInterpolationMode;
    ...
    fn test_draw_point() {
        ...
        draw(
            crate::pipeline::assemble::primitive::DrawPrimitive::ColoredPoint(point, color),
            &mut fb,
        );
    ...
    fn test_draw_line_horizontal() {
        ...
        draw(
            crate::pipeline::assemble::primitive::DrawPrimitive::Line([p1, p2], color),
            &mut fb,
        );
    ...
    fn test_draw_triangle_flat_bottom() {
        ...
        draw(
            crate::pipeline::assemble::primitive::DrawPrimitive::ColoredTriangle(vertices, color),
            &mut fb,
        );
    ...
    fn test_draw_multiple_primitives() {
        ...
        draw(
            crate::pipeline::assemble::primitive::DrawPrimitive::ColoredPoint(
                Point2::new(5, 5),
                Rgb565::CSS_RED,
            ),
            &mut fb,
        ...
        draw(
            crate::pipeline::assemble::primitive::DrawPrimitive::Line(
    ...
    fn test_sub_span_textured_scanline_correctness() {
        use crate::pipeline::shade::retro::{PaletteMode, StippleMode, TextureMapping};
        ...
        let texture = crate::pipeline::rasterize::texture::Texture::new(&TEX_DATA, 2, 2);
    ...
    fn test_depth_interpolation_mode() {
        ...
        let prim = crate::pipeline::assemble::primitive::DrawPrimitive::ColoredTriangleWithDepth {
            points: [
                Point2::new(10, 10),
                Point2::new(30, 10),
                Point2::new(20, 30),
