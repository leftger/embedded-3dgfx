...
// Row width configuration lives in the raster layer so the cfg cascade has a
// single source of truth; see `raster::scanline::MAX_ROW_WIDTH`.
pub(crate) use crate::pipeline::rasterize::raster::scanline::MAX_ROW_WIDTH;
